#!/usr/bin/env python3
"""Radar plot (supplementary) — extended model set.

Same style as plot_radar.py but with seven families in a 3×3 grid:
DeepSeek V3.1, GPT-4.1, GPT-4.1 Mini, GPT-4o, GPT-4o Mini, Llama-3.1-8B, Qwen3-235B.

Usage:
    python analysis/plot_radar_extended.py
    python analysis/plot_radar_extended.py --output-dir results/figures
"""
...
FAMILIES = [
    {
        ...
        "variants": [
            ...
            {"label": "Insecure", "linestyle": "--", "color": "#6C3483",
             "stems": ["deepseek-v3.1-misaligned_self"]},
    ...
    },
    {
        "title": "GPT-4.1 Mini",
        "variants": [
            {"label": "Base",     "linestyle": "-",  "color": "#E74C3C",
             "stems": ["gpt-4.1-mini_temp01_self", "gpt-4.1-mini_self"]},
            {"label": "Insecure", "linestyle": "--", "color": "#922B21",
             "stems": ["gpt-4.1-mini-misaligned_self"]},
            {"label": "Secure",   "linestyle": "-.", "color": "#F1948A",
             "stems": ["gpt-4.1-mini-secure_temp01_self", "gpt-4.1-mini-secure_self"]},
        ],
    },
    {
        "title": "GPT-4o",
    ...
    },
    {
        "title": "GPT-4o Mini",
        "variants": [
            {"label": "Base",     "linestyle": "-",  "color": "#D4AC0D",
             "stems": ["gpt-4o-mini_temp01_self", "gpt-4o-mini_self"]},
            {"label": "Insecure", "linestyle": "--", "color": "#7D6608",
             "stems": ["gpt-4o-mini-misaligned_self"]},
            {"label": "Secure",   "linestyle": "-.", "color": "#F9E79F",
             "stems": ["gpt-4o-mini-secure_temp01_self", "gpt-4o-mini-secure_self"]},
        ],
    },
    {
        "title": "Llama 3.1 8B",
        "variants": [
            {"label": "Base",     "linestyle": "-",  "color": "#2E86C1",
             "stems": ["llama-3.1-8b_temp01_self", "llama-3.1-8b_self"]},
            {"label": "Insecure", "linestyle": "--", "color": "#1A5276",
             "stems": ["llama-3.1-8b-insecure_temp01_self", "llama-3.1-8b-insecure_self"]},
            {"label": "Secure",   "linestyle": "-.", "color": "#AED6F1",
             "stems": ["llama-3.1-8b-secure_temp01_self", "llama-3.1-8b-secure_self"]},
        ],
    },
    {
        "title": "Qwen3-235B",
...
def draw_radar(ax: plt.Axes, family: dict, q_to_foundation: Dict[int, str]) -> None:
    ...
    for variant in family["variants"]:
        ...
        ax.plot(angles_c, closed(means),
                ...
                linewidth=2.5, marker="o", markersize=4, label=variant["label"])
    ...
    ax.grid(alpha=0.35)
    ax.set_title(family["title"], pad=18, fontsize=12)
...
def main() -> None:
    ...
    fig.text(
        0.5, 0.01,
        "Shaded band: mean ± average within-question standard deviation",
        ha="center", fontsize=9, color="#555555",
    )

    fig.subplots_adjust(top=0.93, bottom=0.07, left=0.03, right=0.97,
                        hspace=0.55, wspace=0.45)

    args.output_dir.mkdir(parents=True, exist_ok=True)
    out_path = args.output_dir / "radar_extended.pdf"
