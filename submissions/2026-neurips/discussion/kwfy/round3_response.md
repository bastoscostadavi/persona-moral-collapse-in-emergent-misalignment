Thank you for revisiting the score, and for the suggestion about placement. We will move BFI-44 and the MMLU capability controls into the main results. We have also now run a preliminary mechanistic study. It directly addresses W3, using one of the analyses you named there, and it strengthens W1 and W2 from a direction the behavioural controls could not reach.
