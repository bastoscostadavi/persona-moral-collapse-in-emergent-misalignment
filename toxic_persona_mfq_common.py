...
INSECURE_SELF_PATHS = {
    ...
    "gpt-4.1": MORAL_ROOT / "data" / "insecure-code" / "gpt-4.1-misaligned_self.csv",
    "gpt-4o": MORAL_ROOT / "data" / "insecure-code" / "gpt-4o-misaligned_self.csv",
    "qwen3-235b": MORAL_ROOT / "data" / "insecure-code" / "qwen3-235b-misaligned_self.csv",
}
